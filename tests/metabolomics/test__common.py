...
def test__file_with_standard():
    ...
    actual = metadata_from_filename(fn)
    data = {
        "MS_FILE": "2020_05_11RG_HILICPos15S_Col001_LSARP_SA001_RPT001_Standard-5000nm.mzXML",
        "BI_NBR": None,
        "DATE": datetime.datetime.strptime("2020_05_11", "%Y_%m_%d"),
        "RPT": 1,
        "PLATE_ID": "SA001",
...
def test__file_with_qc01_sample():
    fn = os.path.join(
        LRG_TEST_DATA, "2020_04_20RG_HILICNeg15S_Col002_LSARP_SA008_QC01_SA008.mzXML"
    )
    actual = metadata_from_filename(fn)
    data = {
        "MS_FILE": "2020_04_20RG_HILICNeg15S_Col002_LSARP_SA008_QC01_SA008.mzXML",
        "BI_NBR": None,
...
def test__file_with_qc02_sample():
    fn = os.path.join(
        LRG_TEST_DATA, "2020_04_20RG_HILICNeg15S_Col002_LSARP_SA008_QC02_SA008.mzXML"
    )
    actual = metadata_from_filename(fn)
    data = {
        "MS_FILE": "2020_04_20RG_HILICNeg15S_Col002_LSARP_SA008_QC02_SA008.mzXML",
        "BI_NBR": None,
        "DATE": datetime.datetime.strptime("2020_04_20", "%Y_%m_%d"),
        "RPT": 0,
        "PLATE_ID": "SA008",
...
def test__file_with_SA_pool_sample():
    fn = os.path.join(
        LRG_TEST_DATA, "2020_04_20RG_HILICPos15S_Col001_LSARP_SA008_SA-Pool-4.mzXML"
    )
    actual = metadata_from_filename(fn)
    data = {
        "MS_FILE": "2020_04_20RG_HILICPos15S_Col001_LSARP_SA008_SA-Pool-4.mzXML",
        "BI_NBR": None,
        "DATE": datetime.datetime.strptime("2020_04_20", "%Y_%m_%d"),
        "RPT": 0,
        "PLATE_ID": "SA008",
...
def test__file_with_MH_pool_sample():
    fn = os.path.join(
        LRG_TEST_DATA, "2020_04_20RG_HILICNeg15S_Col002_LSARP_SA008_MH-Pool-1.mzXML"
    )
    actual = metadata_from_filename(fn)
    data = {
        "MS_FILE": "2020_04_20RG_HILICNeg15S_Col002_LSARP_SA008_MH-Pool-1.mzXML",
        "BI_NBR": None,
        "DATE": datetime.datetime.strptime("2020_04_20", "%Y_%m_%d"),
        "RPT": 0,
        "PLATE_ID": "SA008",
...
def test__file_with_blank_sample():
    fn = os.path.join(
        LRG_TEST_DATA, "2020_04_20RG_HILICNeg15S_Col002_LSARP_SA008_Blank2.mzXML"
    )
    actual = metadata_from_filename(fn)
    data = {
        "MS_FILE": "2020_04_20RG_HILICNeg15S_Col002_LSARP_SA008_Blank2.mzXML",
        "BI_NBR": None,
        "DATE": datetime.datetime.strptime("2020_04_20", "%Y_%m_%d"),
        "RPT": 0,
        "PLATE_ID": "SA008",
