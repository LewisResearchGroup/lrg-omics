...
def test__MaxquantProteinQuantNormalizer_all_ones_returns_all_zeros():
...
def test__MaxquantProteinQuantNormalizer_mean_removed():
...
def test__MaxquantProteinQuantNormalizer_same_results_one_or_more_files():
