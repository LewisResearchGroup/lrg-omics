...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Read ThermoFisher worklist and extract data."
    )
    parser.add_argument(
        "-f", dest="fn_inp", help="Input ThermoFisher workist file (csv format)"
    )
    parser.add_argument(
        "-o", dest="fn_out", help="Output file name", default="metadata.csv"
    )
